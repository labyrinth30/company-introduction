...
const NavBar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-white text-black shadow-lg p-4 z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <select
          ...
          className="hidden lg:block ml-8 border rounded-md rounded px-3 bg-white hover:border-blue-500 transition duration-300"
        >
